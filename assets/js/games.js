/* ==========================================================================
   ...
   5 สถานีเล่น: หุ่นยนต์เก็บดาว / อะไรต่อนะ / แยกตะกร้า / ห้องแสงสี / เรียงเรื่องราว
...
(function () {
  ...
  /* ======================================================================
     สถานี 1 — หุ่นยนต์เก็บดาว (ลำดับคำสั่ง) · 8 ด่าน มีตัวอย่างทางเดิน
     ====================================================================== */
  var R_LEVELS = [
  ...
  async function runRobot() {
    ...
    if (won) {
      ...
      celebrate({
        ...
        actions: last
          ? [{ label: 'ไปสถานีถัดไป ▶', cls: 'btn btn--teal', onClick: function () { goTab('pattern'); } },
  ...
  /* ======================================================================
     สถานี 2 — อะไรต่อนะ (รูปแบบ) · 14 ข้อ + ฟังจังหวะช่วยจำ
     ====================================================================== */
  var P_LEVELS = [
    { seq: ['🍎', '🍌', '🍎', '🍌'], ans: '🍎', choices: ['🍇', '🍎', '🍌'] },
    { seq: ['🔴', '🔵', '🔴', '🔵'], ans: '🔴', choices: ['🟢', '🔵', '🔴'] },
      ...
      setTimeout(function () {
        if (pg.i >= P_LEVELS.length - 1) {
          ...
          celebrate({
            ...
            actions: [{ label: 'ไปสถานีถัดไป ▶', cls: 'btn btn--teal', onClick: function () { goTab('sort'); } },
  ...
  /* ======================================================================
     สถานี 3 — แยกตะกร้า · 2 ชุด: แยกตามสี / แยกตามชนิด
     ====================================================================== */
  var S_SETS = [
    {
      ...
      setTimeout(function () {
        ...
        if (!sgb.queue.length) {
          ...
          celebrate({
            ...
            actions: isLastSet
              ? [{ label: 'ไปสถานีถัดไป ▶', cls: 'btn btn--teal', onClick: function () { goTab('studio'); } },
  ...
  /* ======================================================================
     สถานี 4 — ห้องแสงสี · วาดอิสระ + โหมดทำตามแบบ + แกลเลอรี
     ====================================================================== */
  var PALETTE = [
  ...
  /* ======================================================================
     สถานี 5 — เรียงเรื่องราว (ลำดับเหตุการณ์)
     ====================================================================== */
  var ST_SETS = [
